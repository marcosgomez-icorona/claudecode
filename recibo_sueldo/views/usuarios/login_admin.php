        ...
        <div class="card shadow-lg border-0 rounded-lg mt-5">
            <div class="card-header">
                <div class="row">
                    ...
                    <div class="col-10">
                        <h3 class="text-center font-weight-light my-4">Ingreso a Recibos de Sueldo</h3>
                    </div>
                </div>
            ...
            <div class="card-body">
                <form method="POST">
                    ...
                    <div class="form-group">
                        <label  for="password">Clave</label><input class="form-control py-4" id="password" name="password" type="password" placeholder="Ingrese la clave" />
                    </div>                    
                    <div class="form-group ">
