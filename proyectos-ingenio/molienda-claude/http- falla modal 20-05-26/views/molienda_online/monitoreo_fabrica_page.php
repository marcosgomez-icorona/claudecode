...
<div class="dash-btn-bar">
  <span class="text-secondary fw-semibold small me-1">Ver detalles:</span>
  <button class="btn btn-secondary btn-sm" data-bs-toggle="modal" data-bs-target="#indicadoresFabricacionModal">Fabricación</button>
  <button class="btn btn-secondary btn-sm" data-bs-toggle="modal" data-bs-target="#indicadoresTrapicheModal">Trapiche</button>
  <button class="btn btn-secondary btn-sm" data-bs-toggle="modal" data-bs-target="#indicadoresCalderaModal">Caldera</button>
  <button class="btn btn-secondary btn-sm" data-bs-toggle="modal" data-bs-target="#indicadoresUsinaModal">Usina</button>
  <button class="btn btn-secondary btn-sm" data-bs-toggle="modal" data-bs-target="#indicadoresDestileriaModal">Destilería</button>
  <button class="btn btn-secondary btn-sm" onclick="cargarAnalisis()">Análisis Azúcar</button>
  <button class="btn btn-secondary btn-sm" data-bs-toggle="modal" data-bs-target="#resumenfabricaModal">Resumen Fábrica</button>
</div>

<!-- Contenido principal -->
<div class="row g-0 p-1" style="height:calc(100vh - 100px); overflow:hidden;">
