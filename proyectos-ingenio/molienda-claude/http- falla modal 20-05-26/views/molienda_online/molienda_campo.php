  ...
  ?>
  <div class="row">
        <h4 class="text-center my-3">Molienda Online Campo</h4>
  </div>
          ...
          <div class="col-lg-7 left-col">
            <div class="row">
              <div class="col-12 text-start">
                ...
                <div class="row">
                  <div class="col">
                    <button class="btn btn-success btn-sm text-white ms-3 align-items-center text-start" >Excel Completo</button>
                  </div>
                  <div class="col">
                    <button class="btn btn-success btn-sm text-white ms-3 align-items-center text-end" >Excel Reducido</button>
                  </div>
                </div>                
            ...
            <div class="row my-2">
                <div class="col" >
                  <div class="d-flex align-items-center text-start">
                    <span class="ms-1 me-2 fw-bold"><h5 class="card-title">En Canchon</h5></span>
                    <button class="btn btn-success btn-sm text-white ms-3 align-items-center text-start" >Excel</button>
                  </div>                  
                </div>                
            </div>
              <div class="row my-2">
  ...
  <div class="modal fade" id="analisisazucarModal" tabindex="-1" aria-labelledby="analisisazucarModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg"> 
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="analisisazucarModalLabel">Analisis de Azicar</h5>
          <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Cerrar"></button>
        </div>
        <div class="modal-body">
