  <?php
    ...
    foreach ($paradas as $parada):      
          $cant_tiempo_parada = ($cant_tiempo_parada ?? 0) + $parada['T_Neto'] ;   
    endforeach; 
      ...
      <div class="row">
          ...
          <div class="col-lg-6 left-col">
              ...
              <div class="card">
                <div class="card-header">
                  <h4>Indicadores y Analisis</h4>
                  <div class="row">
                    <div class="col text-start">
                      <!--Indicadores -->
                        <button class="btn btn-info btn-sm text-white ms-3" data-bs-toggle="modal" data-bs-target="#indicadoresFabricacionModal">Ind. Fabricación</button>
                        <button class="btn btn-info btn-sm text-white ms-3" data-bs-toggle="modal" data-bs-target="#indicadoresTrapicheModal">Ind. Trapiche</button>
                        <button class="btn btn-info btn-sm text-white ms-3" data-bs-toggle="modal" data-bs-target="#indicadoresCalderaModal">Ind. Caldera</button>
                        <button class="btn btn-info btn-sm text-white ms-3" data-bs-toggle="modal" data-bs-target="#indicadoresUsinaModal">Ind. Usina</button>
                        <button class="btn btn-info btn-sm text-white ms-3" data-bs-toggle="modal" data-bs-target="#indicadoresDestileriaModal">Ind. Destileria</button>                     
                    </div>
                  </div>
                  <div class="row my-1">
                  <div class="col text-start">                      
                      <!-- Analisis -->         
                        <button class="btn btn-secondary btn-sm text-white ms-3" data-bs-toggle="modal" data-bs-target="#analisisazucarModal">Analisis de Azucar</button>                      
                        <button class="btn btn-danger btn-sm text-white ms-3" data-bs-toggle="modal" data-bs-target="#resumenfabricaModal" >Resumen de Fabrica</button>                      
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div class="row">
              <div class="col-12 text-start">
                ...
                <div class="card ">
                  <div class="row m-1">
                    <div class="col-3 ">
                      <button class="btn btn-secondary btn-sm text-white ms-3" data-bs-toggle="modal" data-bs-target="#detallecaniaModal" >Detalle de Caña</button>
                    </div>
                    <div class="col-8">
                      <div class="row">
                        <div class="col-2">
                          <button class="btn btn-secondary btn-sm text-white ms-3" data-bs-toggle="modal" data-bs-target="#paradasModal">
                            Paradas
                          </button>
                        </div>
                        <div class="col-4 m-1">
                          
                            <label class="fw-bold text-dark">Cantidad:</label>
                            <input type="text" class="form-control" 
                                  value="<?php echo $cant_tiempo_parada ?? 0; ?>">
                                         
                        </div>
                        <div class="col-4" >
                          
                            <label class="fw-bold text-dark">Ultima Pesada Hr:</label>
                            <input type="text" class="form-control" 
          ...
          <div class="col-lg-6 right-col">
            ...
            <div class="card p-3 bottom-card">
                ...
                <div class="row my-2">
                  <div class="col">
                    <button class="btn btn-secondary btn-sm text-white ms-3" data-bs-toggle="modal" data-bs-target="#camionescanchonModal">
                    Evolucion x Hora
                    </button>
                  </div>
                  <div class="col" >
                    <div class="d-flex align-items-center text-start">
                            <span class="ms-1 me-2 fw-bold">Acumulado:</span>
                            <input type="text" class="form-control " 
                                      value="<?php echo $acumulado ?? 0; ?>">
                    </div>                  
                    </div>
                    <div class="col" >
                        <div class="d-flex align-items-center text-start">
                            <span class="fw-bold">Promedio x Hora:</span>
                            <input type="text" class="form-control " 
                                      value="<?php echo $promedio_hora ?? 0; ?>">
                        </div>                  
                    </div>
                    <div class="col" >
                        <div class="d-flex align-items-center text-start">
                            <span class="fw-bold">Promedio x Dia:</span>
                            <input type="text" class="form-control " 
                                      value="<?php echo $promedio_dia ?? 0; ?>">
                        </div>                  
                    </div>
                    <div class="col">
  ...
  <div class="modal fade" id="camionescanchonModal" tabindex="-1" aria-labelledby="camionescanchonModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg"> 
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="camionescanchonModalLabel">Evolucion x Hora</h5>
          <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Cerrar"></button>
        </div>
        <div class="modal-body">
  ...
  <div class="modal fade" id="indicadoresFabricacionModal" tabindex="-1" aria-labelledby="indicadoresFabricacionModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-md" style="max-width: 700px;"> 
      <div class="modal-content">
        <div class="modal-header"> 
          <div class="h1 text-secondary text-end">#8</div> <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Cerrar"></button>        
  ...
  <div class="modal fade" id="indicadoresTrapicheModal" tabindex="-1" aria-labelledby="indicadoresTrapicheModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-md" style="max-width: 700px;"> 
      <div class="modal-content">
        <div class="modal-header">          
          <div class="h1 text-secondary text-end">#3</div> <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Cerrar"></button>        
        </div>
        <div class="modal-body fw-bold">
  ...
  <div class="modal fade" id="indicadoresUsinaModal" tabindex="-1" aria-labelledby="indicadoresUsinaModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-md" style="max-width: 700px;"> 
      <div class="modal-content">
        <div class="modal-header">          
          <div class="h1 text-secondary text-end">#2</div> <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Cerrar"></button>        
        </div>
        <div class="modal-body fw-bold">
  ...
  <div class="modal fade" id="indicadoresDestileriaModal" tabindex="-1" aria-labelledby="indicadoresDestileriaModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-md" style="max-width: 700px;"> 
      <div class="modal-content">
        <div class="modal-header">          
          <div class="h1 text-secondary text-end">#4</div> <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Cerrar"></button>        
        </div>
        <div class="modal-body fw-bold">
  ...
  <div class="modal fade" id="analisisazucarModal" tabindex="-1" aria-labelledby="analisisazucarModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg"> 
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="analisisazucarModalLabel">Analisis de Azucar</h5>
          <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Cerrar"></button>
        </div>
        <div class="modal-body">
          <?php include 'views/indicadores_fabrica/analisis_azucar.php'; ?>
        </div>
        <div class="modal-footer">
  ...
  <div class="modal fade" id="resumenfabricaModal" tabindex="-1" aria-labelledby="resumenfabricaModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg"> 
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="resumenfabricaModalLabel">Resumen de Fabrica</h5>
          <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Cerrar"></button>
        </div>
        <div class="modal-body">
  ...
  <script>
    ...
    window.onload = function() {
      // refrescar cada 60 segundos (60000 milisegundos)
      setTimeout(function() {
        location.reload();
      }, 1000000);
    };
