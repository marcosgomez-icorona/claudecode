...
//Funcion para formato de fecha
	...
	function rango_hora($hora) {
		...
		// La hora almacenada es la hora de CIERRE del período.
		// Ej: '11:00' = período 10:00–11:00 → mostrar "10:00 a 11:00"
		$ts_cierre = strtotime($hora);
		$ts_inicio = strtotime('-1 hour', $ts_cierre);

		return date('H:i', $ts_inicio) . ' a ' . date('H:i', $ts_cierre);
	}
