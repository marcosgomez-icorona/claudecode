  ...
  <div class="dash-btn-bar">
    <button class="btn btn-info btn-sm text-white" data-bs-toggle="modal" data-bs-target="#indicadoresFabricacionModal">Ind. Fabricación</button>
    <button class="btn btn-info btn-sm text-white" data-bs-toggle="modal" data-bs-target="#indicadoresTrapicheModal">Ind. Trapiche</button>
    <button class="btn btn-info btn-sm text-white" data-bs-toggle="modal" data-bs-target="#indicadoresCalderaModal">Ind. Caldera</button>
    <button class="btn btn-info btn-sm text-white" data-bs-toggle="modal" data-bs-target="#indicadoresUsinaModal">Ind. Usina</button>
    <button class="btn btn-info btn-sm text-white" data-bs-toggle="modal" data-bs-target="#indicadoresDestileriaModal">Ind. Destilería</button>
    ...
    <button class="btn btn-danger btn-sm text-white" data-bs-toggle="modal" data-bs-target="#resumenfabricaModal">Resumen Fábrica</button>
  </div>

  <!-- Contenido principal -->
  <div class="row g-0 p-1 h-[calc(100vh-115px)] overflow-hidden">

    <!-- Columna izquierda: datos de molienda -->
    <div class="col-lg-6 pe-1 d-flex flex-column gap-1 h-full">
        ...
        <table class="table table-sm table-bordered dash-data-table mb-0">
          ...
          <tbody>
            <tr>
              ...
              <td class="text-center"><?php echo $cania_bruta ?? 0; ?></td>
              <td class="text-center"><?php echo $cania_bruta_uc ?? 0; ?></td>
              <td class="text-center"><?php echo $acumulado_cania ?? 0; ?></td>
            </tr>
            <tr>
              <td class="fw-semibold text-secondary">Trash Pond.</td>
              <td class="text-center"><?php echo $trash_ponderado ?? 0; ?></td>
              <td class="text-center"><?php echo $trash_ponderado_uc ?? 0; ?></td>
              <td class="text-center"><?php echo $trash_ponderado_acumulado ?? 0; ?></td>
            </tr>
            <tr>
              <td class="fw-semibold text-secondary">Trash Kg</td>
              <td class="text-center"><?php echo $trash_kg ?? 0; ?></td>
              <td class="text-center">—</td>
              <td class="text-center">—</td>
            </tr>
            <tr>
              <td class="fw-semibold text-secondary">Caña Neta</td>
              <td class="text-center"><?php echo $cania_neta ?? 0; ?></td>
              <td class="text-center"><?php echo $cania_neta_uc ?? 0; ?></td>
              <td class="text-center"><?php echo $cania_neta_acumulado ?? 0; ?></td>
            </tr>
            <tr>
              <td class="fw-semibold text-secondary">Rto. Ponderado</td>
              <td class="text-center"><?php echo $rdto_ponderado ?? 0; ?></td>
              <td class="text-center"><?php echo $rdto_ponderado_uc ?? 0; ?></td>
              <td class="text-center"><?php echo $rdto_ponderado_acumulado ?? 0; ?></td>
            </tr>
            <tr>
              <td class="fw-semibold text-secondary">Brix Ponderado</td>
              <td class="text-center"><?php echo $brix_ponderado ?? 0; ?></td>
              <td class="text-center"><?php echo $brix_ponderado_uc ?? 0; ?></td>
              <td class="text-center"><?php echo $brix_ponderado_acumulado ?? 0; ?></td>
            </tr>
            <tr>
              <td class="fw-semibold text-secondary">Pol Ponderado</td>
              <td class="text-center"><?php echo $pol_ponderado ?? 0; ?></td>
              <td class="text-center"><?php echo $pol_ponderado_uc ?? 0; ?></td>
              <td class="text-center"><?php echo $pol_ponderado_acumulado ?? 0; ?></td>
            </tr>
            <tr>
              <td class="fw-semibold text-secondary">Pureza Pond.</td>
              <td class="text-center"><?php echo $pureza_ponderada ?? 0; ?></td>
              <td class="text-center"><?php echo $pureza_ponderada_uc ?? 0; ?></td>
              <td class="text-center"><?php echo $pureza_ponderada_acumulado ?? 0; ?></td>
            </tr>
          </tbody>
        </table>
      </div>
      <div class="card p-2 flex-grow-1 overflow-auto min-h-0">
      ...
      <div class="card p-2 flex-shrink-0">
        <div class="d-flex align-items-center flex-wrap gap-2" style="font-size:0.8rem;">
          <button class="btn btn-secondary btn-sm" data-bs-toggle="modal" data-bs-target="#paradasModal">Paradas</button>
          <div class="d-flex align-items-center gap-1">
            <span class="fw-semibold text-secondary">Total:</span>
            <input type="text" class="form-control form-control-sm" style="width:85px;" value="<?php echo $cant_tiempo_parada ?? 0; ?>">
          </div>
          <div class="d-flex align-items-center gap-1">
            <span class="fw-semibold text-secondary">Últ. Pesada:</span>
            <input type="text" class="form-control form-control-sm" style="width:65px;" value="<?php echo $hora_ultima_pesada ?? ''; ?>">
          </div>
          <div class="d-flex align-items-center gap-1">
            <span class="fw-semibold text-secondary">Pol Bagazo:</span>
            <input type="text" class="form-control form-control-sm" style="width:60px;" value="<?php echo $pol_prom_bagazo ?? 0; ?>">
          </div>
          <div class="d-flex align-items-center gap-1">
            <span class="fw-semibold text-secondary">Pol Cachaza:</span>
            <input type="text" class="form-control form-control-sm" style="width:60px;" value="<?php echo $pol_prom_cachaza ?? 0; ?>">
          </div>
          <div class="d-flex align-items-center gap-1">
            <span class="fw-semibold text-secondary">Agua Imbibición:</span>
            <input type="text" class="form-control form-control-sm" style="width:70px;" value="<?php echo $opc['agua_imbibicion'] ?? '--'; ?>">
          </div>
        </div>
      </div>
    ...
    <div class="col-lg-6 ps-1 d-flex flex-column gap-1 h-full">

      <div class="card p-2 flex-grow-1 overflow-y-auto min-h-0">
        <?php include 'datos_molienda_hora.php';
              //include 'conexion_test_supabase.php';
        ?>
      </div>
