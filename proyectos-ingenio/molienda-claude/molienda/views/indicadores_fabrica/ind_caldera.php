<div class="indicator-grid">
  ...
  <div class="ind-section">
    ...
    <div class="ind-card semaforo-card"
         data-valor="--" data-objetivo="1.5" data-direction="target">
    ...
    <div class="ind-card semaforo-card"
      ...
      <div class="ind-row">
        ...
        <div class="ind-field"><span class="ind-caption">Prom. T. ant.</span>
          <input type="text" class="form-control form-control-sm ind-input" value="<?php echo $gas_prom_turno_ant ?? '--'; ?>" readonly></div>
      </div>
    </div>
