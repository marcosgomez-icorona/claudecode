...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 13-05-2026 a las 13:40:33
...
--
CREATE DATABASE IF NOT EXISTS `db_corona` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `db_corona`;
...
) ENGINE=InnoDB AUTO_INCREMENT=6942046 DEFAULT CHARSET=utf8mb4;
...
CREATE TABLE IF NOT EXISTS `calidadbagazo_xhora` (
  ...
  KEY `idx_proceso` (`codigoproceso`)
) ENGINE=InnoDB AUTO_INCREMENT=36343 DEFAULT CHARSET=utf8mb4;
...
) ENGINE=InnoDB AUTO_INCREMENT=375983 DEFAULT CHARSET=utf8mb4;
...
) ENGINE=InnoDB AUTO_INCREMENT=3889234 DEFAULT CHARSET=utf8mb4;
...
CREATE TABLE IF NOT EXISTS `calidadmelaza_xhora` (
  ...
  KEY `idx_fecha` (`fechaindustrial`),
  KEY `idx_proceso` (`codigoproceso`)
) ENGINE=InnoDB AUTO_INCREMENT=59251 DEFAULT CHARSET=utf8mb4;
...
) ENGINE=InnoDB AUTO_INCREMENT=212257 DEFAULT CHARSET=utf8mb4;
...
) ENGINE=InnoDB AUTO_INCREMENT=142942 DEFAULT CHARSET=utf8mb4;
...
) ENGINE=InnoDB AUTO_INCREMENT=10160 DEFAULT CHARSET=utf8mb4;
...
CREATE TABLE IF NOT EXISTS `molienda_xhora` (
  ...
  KEY `idx_fecha` (`fechaindustrial`),
  KEY `idx_hora` (`hora`)
) ENGINE=InnoDB AUTO_INCREMENT=6987584 DEFAULT CHARSET=utf8mb4;
...
) ENGINE=InnoDB AUTO_INCREMENT=14205 DEFAULT CHARSET=utf8mb4;
...
) ENGINE=InnoDB AUTO_INCREMENT=737520 DEFAULT CHARSET=utf8mb4;
