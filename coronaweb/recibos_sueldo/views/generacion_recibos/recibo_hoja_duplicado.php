...
<div class="recibo border border-dark" style="font-family: Arial, sans-serif; font-size:10px; box-sizing:border-box; width:100%;">
    ...
    <div class="row m-2 border-bottom pb-1">
        <div class="col-6">
            ...
            <div>Legajo N°: <?php echo htmlspecialchars($item['leg'] ?? ''); ?></div>
        ...
        <div class="col-6">
            ...
            <div>Est.Civil: <?php echo htmlspecialchars($item['estado_civil'] ?? ''); ?></div>
        ...
        <table class="table table-bordered table-sm" style="font-size: 9px; width:100%; table-layout:fixed;">
            ...
            <tbody class="text-end">
                ...
                <tr>
                    ...
                    <td><strong>Tot. NoRemun.</strong></td>
    ...
    <div class="row m-2 border-bottom pb-1">
        <div class="col">
            ...
            <div>en concepto de mis haberes del periodo arriba indicado segun la presente liquidacion de la cual he recibido copia.</div>
        </div>
    </div>                          
    <div class="row m-2">
        <div class="col-7">
            <div>Fecha de Pago: <?php echo fechaDma($item['fecha_pago'] ?? '') ; ?></div>
        ...
        <div class="col-3" style="font-size:8px;">
            <strong>
                    <div>-----------------------------------------</div>
                    <div class="text-center">Firma Empleado</div>
                    <br>
                    <div>-----------------------------------------</div>
                    <div class="text-center">Aclaracion Empleado</div>
            </strong>
        </div>
