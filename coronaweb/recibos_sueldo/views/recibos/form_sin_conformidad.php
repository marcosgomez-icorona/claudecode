...
$nombre_empleado = !empty($recibos_empleado[0]['nombre']) ? $recibos_empleado[0]['nombre'] : 'Empleado Desconocido';
    ...
    <div class="p-4 bg-light shadow rounded">
        <div class="container my-5">
            <div class="d-flex flex-column flex-md-row justify-content-between align-items-center mb-4 pb-3 border-bottom">
                ...
                <div>
                    <a href="view.php?menu=cambiar_clave&legajo=MDk2NDA=" class="btn btn-outline-info me-2">
                    ...
                    <p class="h3 m-2">
                     <span class="fw-bold text-secondary">
                        ...
                        <?php
                                ...
                                echo $anio.' / '.$mes.' '.$quincena;
                                
                        ?>
                    </span>
                    </p> 
                    <button class="btn btn-success ms-md-3" onclick="abrirModalConformidad('<?php echo $ruta_ultimo_recibo ?? '';?>')">
                        Ver Último Recibo
                    </button>
                    <?php else: ?>
                    ...
                    <table class="table table-striped table-hover table-sm text-secondary justify-content-center">
                        <thead class="table-secondary">
                            <tr>
                                ...
                                <?php if(!empty($quincena)){
                                        echo '<th scope="col" class="text-dark">Quincena</th>';
                                    }
                                ?>                                
                                ...
                                ?> 
                                    <td>                                        
                                        <a class="btn btn-outline-info btn-sm hover-shadow-sm transition-ease" href="#" onclick="descargarPDF('<?php echo $ruta_recibo; ?>')">
                                            <i class="fas fa-file-alt me-1"></i> Ver Recibo
                                        </a>
                                    </td>
                                </tr>
                            <?php endforeach; ?>
                ...
                <div class="modal-dialog modal-dialog-centered">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ¿Está de acuerdo con los datos del recibo? Al hacer clic en "Aceptar y Descargar" confirma la recepción del mismo.
                        </div>
...
<script>
    ...
    function abrirModalConformidad(rutaPDF) {
