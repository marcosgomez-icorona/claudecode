                    ...
                    <div class="row m-2">
                        ...
                        <div class="col-md-3 mb-1">
                            ...
                            <select name="tipo_liq" id="tipo_liq" class="form-control">
                                ...
                                <option value="1er-SAC">MEDIO SAC 1er SEMESTRE</option>
                                <option value="2do-SAC">MEDIO SAC 2do SEMESTRE</option>
                        ...
                        <div class="col-md-3 mb-1">
                            ...
                            <input name="detalle" id="detalle" class="form-control" value="">
                        </div> 
                    </div>
                    <div class="row m-2">
