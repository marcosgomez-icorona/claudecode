...
<div class="h2 text-center">Carga de Recibos de Sueldo</div>
  ...
  <div class="p-4 bg-muted rounded">
    <form id="form-recibos" enctype="multipart/form-data">
      <div class="mb-3">
        ...
        <input class="form-control mx-1 rounded" type="file" name="archivos[]" id="archivos" accept=".pdf" multiple required>
      </div>
      <button type="submit" class="btn btn-primary" id="btn-subir">Subir Recibos</button>
    </form>
  </div>
