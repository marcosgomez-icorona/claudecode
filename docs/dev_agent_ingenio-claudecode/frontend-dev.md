---
name: frontend-dev
description: Use this agent when a project needs frontend implementation or improvement — HTML, CSS, Bootstrap, JavaScript, dashboards, tables, forms, charts, responsiveness, or visual polish for Ingenio internal webapps. Use it for implementation; for new visual/UI design direction on a from-scratch screen, consider pairing with the frontend-design skill for styling decisions before implementing.
